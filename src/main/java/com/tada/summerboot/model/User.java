...
public class User {
    ...
    public User( String userType, String username, String email, String password, String retype_password, Integer telephone, String address, String unit, Integer postal) {
        this.username = username;
        this.email = email;
        this.password = password;
        this.retype_password = retype_password;
